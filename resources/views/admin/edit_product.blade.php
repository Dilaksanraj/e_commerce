						...
						<form class="form-horizontal" method="post" action="{{url('/update-product',$product_info->product_id)}}" enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" required="" name="category_id" required="">
							...
							<?php } ?>
							 ...
							 <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError3" required="" name="manufacture_id" required="">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="number" class="input-xlarge" name="product_quantity" required="" value="{{$product_info -> product_quantity}}">
							  </div>
							</div>
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Add to sales</label>
							  <div class="controls">
							  <input type="checkbox" value="1" name="product_sale" value="{{$product_info -> product_sale}}" value="{{$product_info -> product_sale}}"/>
							  </div>
							</div>
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Add to new arrival</label>
							  <div class="controls">
							  <input type="checkbox" value="1" name="product_new" value="{{$product_info -> product_new}}" value="{{$product_info -> product_sale}}"/>
							  </div>
							</div>
