...
<head>
	...
	<link rel="shortcut icon" href="{{asset('backEnd/img/bike.png')}}">
	<!-- end: Favicon -->
...
<body>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					<div class="icons">
						<a href="/myProject/public"><i class="halflings-icon home"></i></a>
					...
					<form class="form-horizontal" action="{{url('/admin-dashboard')}}" method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="admin_email" id="username" type="text" placeholder="mail address"/>
							</div>
